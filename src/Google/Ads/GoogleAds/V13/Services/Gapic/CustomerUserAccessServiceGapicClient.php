...
class CustomerUserAccessServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v13.services.CustomerUserAccessService';
    ...
    private static ?\Google\ApiCore\PathTemplate $customerUserAccessNameTemplate = null;
