...
class CustomAudienceError
{
     ...
     */
    public const CANNOT_REMOVE_WHILE_IN_USE = 3;
    /**
     ...
     */
    public const RESOURCE_ALREADY_REMOVED = 4;
    /**
