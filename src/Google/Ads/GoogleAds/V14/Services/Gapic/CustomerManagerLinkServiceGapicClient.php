...
class CustomerManagerLinkServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerManagerLinkService';
    ...
    private static ?\Google\ApiCore\PathTemplate $customerManagerLinkNameTemplate = null;
