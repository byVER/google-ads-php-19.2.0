...
class CustomerAssetSetServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerAssetSetService';
    ...
    private static ?\Google\ApiCore\PathTemplate $customerAssetSetNameTemplate = null;
