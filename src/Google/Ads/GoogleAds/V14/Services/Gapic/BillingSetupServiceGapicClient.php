...
class BillingSetupServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v14.services.BillingSetupService';
    ...
    private static ?\Google\ApiCore\PathTemplate $paymentsAccountNameTemplate = null;
