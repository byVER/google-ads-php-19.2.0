...
class CustomInterestServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomInterestService';
    ...
    private static ?\Google\ApiCore\PathTemplate $customInterestNameTemplate = null;
