...
class GoogleAdsFieldServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v14.services.GoogleAdsFieldService';
    ...
    private static ?\Google\ApiCore\PathTemplate $googleAdsFieldNameTemplate = null;
