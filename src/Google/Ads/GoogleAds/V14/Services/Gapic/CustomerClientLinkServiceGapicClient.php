...
class CustomerClientLinkServiceGapicClient
{
    ...
    public const SERVICE_NAME = 'google.ads.googleads.v14.services.CustomerClientLinkService';
    ...
    private static ?\Google\ApiCore\PathTemplate $customerClientLinkNameTemplate = null;
