        ...
        'google.ads.googleads.v14.services.BatchJobService' => [
            'RunBatchJob' => [
                'longRunning' => [
                    ...
                    'metadataReturnType' => '\\' . \Google\Ads\GoogleAds\V14\Resources\BatchJob\BatchJobMetadata::class,
            ...
            'AddBatchJobOperations' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V14\Services\AddBatchJobOperationsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'resource_name',
                        'fieldAccessors' => [
            ...
            'ListBatchJobResults' => [
                ...
                'responseType' => \Google\Ads\GoogleAds\V14\Services\ListBatchJobResultsResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'resource_name',
                        'fieldAccessors' => [
            ...
            'MutateBatchJob' => [
                'callType' => \Google\ApiCore\Call::UNARY_CALL,
                'responseType' => \Google\Ads\GoogleAds\V14\Services\MutateBatchJobResponse::class,
                'headerParams' => [
                    [
                        'keyName' => 'customer_id',
                        'fieldAccessors' => [
