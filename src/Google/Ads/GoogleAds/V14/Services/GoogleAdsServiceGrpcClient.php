...
class GoogleAdsServiceGrpcClient extends \Grpc\BaseStub {
    ...
    public function Search(\Google\Ads\GoogleAds\V14\Services\SearchGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\\' . \Google\Ads\GoogleAds\V14\Services\SearchGoogleAdsResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function SearchStream(\Google\Ads\GoogleAds\V14\Services\SearchGoogleAdsStreamRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\\' . \Google\Ads\GoogleAds\V14\Services\SearchGoogleAdsStreamResponse::class, 'decode'],
        $metadata, $options);
    }
    ...
    public function Mutate(\Google\Ads\GoogleAds\V14\Services\MutateGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        ...
        $argument,
        ['\\' . \Google\Ads\GoogleAds\V14\Services\MutateGoogleAdsResponse::class, 'decode'],
        $metadata, $options);
    }
