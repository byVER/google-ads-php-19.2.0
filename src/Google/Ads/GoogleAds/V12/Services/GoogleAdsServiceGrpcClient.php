...
class GoogleAdsServiceGrpcClient extends \Grpc\BaseStub {
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function Search(\Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v12.services.GoogleAdsService/Search',
        $argument,
        ['\\' . \Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsResponse::class, 'decode'],
        $metadata, $options);
    }
     ...
     *   [QuotaError]()
     *   [RequestError]()
     * @param \Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsStreamRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\ServerStreamingCall
     */
    public function SearchStream(\Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsStreamRequest $argument,
      $metadata = [], $options = []) {
        return $this->_serverStreamRequest('/google.ads.googleads.v12.services.GoogleAdsService/SearchStream',
        $argument,
        ['\\' . \Google\Ads\GoogleAds\V12\Services\SearchGoogleAdsStreamResponse::class, 'decode'],
        $metadata, $options);
    }
     ...
     * @param \Google\Ads\GoogleAds\V12\Services\MutateGoogleAdsRequest $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function Mutate(\Google\Ads\GoogleAds\V12\Services\MutateGoogleAdsRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/google.ads.googleads.v12.services.GoogleAdsService/Mutate',
        $argument,
        ['\\' . \Google\Ads\GoogleAds\V12\Services\MutateGoogleAdsResponse::class, 'decode'],
        $metadata, $options);
    }
