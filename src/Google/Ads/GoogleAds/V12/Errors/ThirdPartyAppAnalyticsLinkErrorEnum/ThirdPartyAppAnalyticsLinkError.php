...
class ThirdPartyAppAnalyticsLinkError
{
     ...
     */
    public const MOBILE_APP_IS_NOT_ENABLED = 4;
    /**
     ...
     */
    public const CANNOT_REGENERATE_SHAREABLE_LINK_ID_FOR_REMOVED_LINK = 5;
